...
// calculate sentence lengths in words that are any sequence of characters
// other than spaces or sentence ending characters
function getSentenceLengths(sentences) {
  var sentenceLengths = sentences.map(function(sentence) {
